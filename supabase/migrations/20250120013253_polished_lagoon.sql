...
-- Create indexes
CREATE INDEX idx_cash_flow_forecast_user_id ON cash_flow_forecast(user_id);
CREATE INDEX idx_cash_flow_forecast_year_month ON cash_flow_forecast(year, month);
CREATE INDEX idx_cash_flow_forecast_group_id ON cash_flow_forecast(group_id);
CREATE INDEX idx_cash_flow_forecast_account_id ON cash_flow_forecast(account_id);
