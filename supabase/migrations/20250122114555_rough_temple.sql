...
CREATE INDEX idx_account_cost_centers_account_id ON account_cost_centers(account_id);
CREATE INDEX idx_account_cost_centers_cost_center_id ON account_cost_centers(cost_center_id);
CREATE INDEX idx_entry_cost_centers_entry_id ON entry_cost_centers(entry_id);
CREATE INDEX idx_entry_cost_centers_cost_center_id ON entry_cost_centers(cost_center_id);
...
CREATE VIEW cost_center_totals AS
SELECT
